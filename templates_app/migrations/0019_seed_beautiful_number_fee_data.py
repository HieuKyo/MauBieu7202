...
def seed_detailed_fee_tiers(apps, schema_editor):
    ...
    # Data from Bảng 1 - Agribank Giá Rai (Phí tối thiểu 500,000 VNĐ)
    tiers_data = [
        # Loại thường
        {'quantity': 2, 'fee_type': 'NORMAL', 'min_fee': 500000, 'max_fee': 1000000},
        {'quantity': 3, 'fee_type': 'NORMAL', 'min_fee': 500000, 'max_fee': 1000000},
...
def seed_on_request_fee_tiers(apps, schema_editor):
    ...
    # Data from Bảng 2 - Agribank Giá Rai (Phí tối thiểu 500,000 VNĐ)
    tiers_data = [
        {'min_quantity': 2, 'max_quantity': 5, 'min_fee': 500000, 'max_fee': 1000000},
