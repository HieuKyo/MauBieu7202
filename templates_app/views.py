...
def variable_library_view(request):
    ...
    branch_variables = [
        ...
        {'name': 'gcndkdn', 'description': 'Giấy chứng nhận đăng ký kinh doanh', 'example': '0123456789'},
        {'name': 'mst_chi_nhanh', 'description': 'Mã số thuế chi nhánh', 'example': '0123456789-001'},
